...
local Connected = connect(function(state)
	...
	return _object
end)(OutlinedButtonBase)
local OutlinedButton
do
	OutlinedButton = Roact.Component:extend("OutlinedButton")
	function OutlinedButton:init()
	end
	function OutlinedButton:render()
		local _attributes = {
			store = ThemeStore,
		}
		local _children = {}
