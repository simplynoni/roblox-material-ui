...
class TonalButton extends Roact.Component<TonalButtonProps & ThemeProps, TonalButtonState> {
	...
	constructor(props: TonalButtonProps & ThemeProps) {
		super(props);
...
const Connected = connect<{ Theme: ThemeState }, {}, TonalButtonProps, ThemeState>((state) => {
	return {
		Theme: { ...state },
	};
})(TonalButton);

export default class ThemedOutlinedButton extends Roact.Component<TonalButtonProps> {
	render() {
		return (
